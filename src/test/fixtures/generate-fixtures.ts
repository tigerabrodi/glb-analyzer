...
async function generateBowtie(io: NodeIO): Promise<void> {
  ...
  const indices = [
    ...
    2,
    3,
    4, // Second triangle (shares vertex 2 only)
  ]
...
async function generateFlippedFace(io: NodeIO): Promise<void> {
  ...
  const indices = [
    ...
    0,
    3,
    2, // Reversed from: 0,1,2 and 0,2,3
    // Back face - normal
    4,
    6,
    5,
...
async function generateDuplicateVertices(io: NodeIO): Promise<void> {
  ...
  const positions = [
    ...
    1,
    1,
    0, // 2 - same position as vertex 4
    0,
    1,
    0, // 3 - same position as vertex 5
    // Second triangle (duplicated edge vertices)
    1,
    1,
    0, // 4 - duplicate of vertex 2
    0,
    1,
    0, // 5 - duplicate of vertex 3
    0,
    2,
    0, // 6
    1,
...
async function generateSelfIntersecting(io: NodeIO): Promise<void> {
  ...
  const indices = [
    ...
    3,
    4,
    5, // Second triangle (intersects first)
  ]
